...
public abstract class BaseRepository<TEntity> : IBaseRepository<TEntity> where TEntity : class
{
    ...
    public Task<RepositoryResult<TResult>> DeleteAsync<TResult>(TEntity entity)
    {
        throw new NotImplementedException();
    }

    public Task<RepositoryResult<IEnumerable<TEntity>>> GetAllAsync(TEntity entity)
    {
        throw new NotImplementedException();
    }

    public Task<RepositoryResult<TResult>> UpdateAsync<TResult>(TEntity entity)
    {
        throw new NotImplementedException();
    }
}
